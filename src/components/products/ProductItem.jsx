...
export default function ProductItem({ src, alt, href }) {
  return (
    <Link href={href}>
      <div className="h-[450px] shadow-xl shadow-slate-300 w-[320px] mb-6">
        <div className=" w-full h-full">
          ...
          <div className="">
            <h2 className="text-center font-bold text-2xl mt-2"> Crud Ring</h2>
            <div className="flex justify-start  font-semibold text-xl mt-3">
              <h2 className="line-through mx-3"> रू 350 </h2>
              <h2 className="text-orange-500"> रू 200</h2>
            </div>
